...
export type SocketConfig = {
    ...
    /** should CiaaTopUp use the mobile api instead of the multi device api
    ...
    /** Should CiaaTopUp ask the phone for full history, will be received async */
    syncFullHistory: boolean;
    /** Should CiaaTopUp fire init queries automatically, default true */
