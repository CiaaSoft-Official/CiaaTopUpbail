...
export type CiaaTopUpEvent = keyof CiaaTopUpEventMap;
export interface CiaaTopUpEventEmitter {
    on<T extends keyof CiaaTopUpEventMap>(event: T, listener: (arg: CiaaTopUpEventMap[T]) => void): void;
    off<T extends keyof CiaaTopUpEventMap>(event: T, listener: (arg: CiaaTopUpEventMap[T]) => void): void;
    removeAllListeners<T extends keyof CiaaTopUpEventMap>(event: T): void;
    emit<T extends keyof CiaaTopUpEventMap>(event: T, arg: CiaaTopUpEventMap[T]): boolean;
}
