...
const makeMessagesSocket = (config) => {
    ...
    return {
        ...
        sendMessage: async (jid, content, options = {}) => {
            ...
            // ── FIX: CiaaTopUp Button Format Compatibility Bridge ─────────────
            // Bot yang pakai format button lama (seperti di library lain):
            // { buttons: [{buttonId:'x', buttonText:{displayText:'y'}, type:1}] }
            // dikonversi ke interactiveButtons CiaaTopUp agar bisa diproses
            ...
            // ── End CiaaTopUp Button Format Compatibility Bridge ──────────────
            ...
            // ── FIX: Album Message Handler (CiaaTopUp-compatible + delay configurable) ──
