...
exports.fetchLatestAstraVersion = exports.asciiDecode = exports.asciiEncode = exports.fromUnicodeEscape = exports.toUnicodeEscape = exports.printQRIfNecessaryListener = exports.COMPANION_PLATFORM_MAP = exports.isWABusinessPlatform = exports.getCodeFromWSError = exports.getCallStatusFromNode = exports.getErrorCodeFromStreamError = exports.getStatusFromReceiptType = exports.generateMdTagPrefix = exports.fetchLatestWaWebVersion = exports.fetchLatestCiaaTopUpVersion = exports.bindWaitForConnectionUpdate = exports.generateMessageID = exports.generateMessageIDV2 = exports.delayCancellable = exports.delay = exports.debouncedTimeout = exports.unixTimestampSeconds = exports.toNumber = exports.encodeBigEndian = exports.generateRegistrationId = exports.encodeWAMessage = exports.generateParticipantHashV2 = exports.unpadRandomMax16 = exports.writeRandomPadMax16 = exports.isStringNullOrEmpty = exports.getKeyAuthor = exports.BufferJSON = void 0;
...
const waVer = require('../Defaults/ciaatopupbail-version.json');
const CiaaTopUpVersion = waVer?.version || [2, 3000, 1036687490];
...
/**
 * utility that fetches latest CiaaTopUp version from the master branch.
 * Use to ensure your WA connection is always on the latest version
 */
const fetchLatestCiaaTopUpVersion = async (options = {}) => {
    const URL = 'https://raw.githubusercontent.com/ciaatopupofficial/CiaaTopUpbail/main/src/Defaults/index.ts';
    try {
        ...
        if (!response.ok) {
            throw new boom_1.Boom(`Failed to fetch latest CiaaTopUp version: ${response.statusText}`, { statusCode: response.status });
        }
        ...
        return {
            version: CiaaTopUpVersion,
            isLatest: false,
            error
        };
    }
};
exports.fetchLatestCiaaTopUpVersion = fetchLatestCiaaTopUpVersion;
/**
...
/**
 * Stream errors generally provide a reason, map that to a CiaaTopUp DisconnectReason
...
exports.fetchLatestBaileysVersion = exports.fetchLatestAstraVersion = exports.fetchLatestCiaaTopUpVersion;
