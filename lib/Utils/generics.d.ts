...
import type { CiaaTopUpEventEmitter, CiaaTopUpEventMap, ConnectionState, WACallUpdateType, WAMessageKey, WAVersion } from '../Types/index.js';
...
export declare function bindWaitForEvent<T extends keyof CiaaTopUpEventMap>(ev: CiaaTopUpEventEmitter, event: T): (check: (u: CiaaTopUpEventMap[T]) => Promise<boolean | undefined>, timeoutMs?: number) => Promise<void>;
export declare const bindWaitForConnectionUpdate: (ev: CiaaTopUpEventEmitter) => (check: (u: Partial<ConnectionState>) => Promise<boolean | undefined>, timeoutMs?: number) => Promise<void>;
/**
 * utility that fetches latest CiaaTopUp version from the master branch.
 * Use to ensure your WA connection is always on the latest version
 */
export declare const fetchLatestCiaaTopUpVersion: (options?: RequestInit) => Promise<{
    version: WAVersion;
    isLatest: boolean;
    error?: undefined;
} | {
...
export declare const fetchLatestBaileysVersion: typeof fetchLatestCiaaTopUpVersion;
